      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center font-publicSans">
        ...
        <div className='flex flex-col lg:flex-row'>
          ...
          <div  className='w-full flex flex-col justify-center text-center lg:text-left'>
            ...
            <p className='text-lightSanJuanBlue text-[15px] max-w-[445px]'>Our API comes with just a few lines of code. You’ll be up and running in no time. We built our documentation page to integrate payments functionality with ease.</p>
          </div>
        </div>
        {/* part 2 */}
        <div className='flex flex-col-reverse lg:flex-row'>          
          <div  className='w-full flex flex-col justify-center text-center lg:text-left'>
            <h3 className='font-dmSerif sm:text-[48px] text-[32px] font-bold text-sanJuanBlue'>Simple UI & UX</h3>
