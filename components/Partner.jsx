        ...
        <div className='flex flex-col-reverse lg:flex-row'>
          <div className=' w-full'>
            ...
            <div className='text-white flex flex-col justify-center text-center lg:text-left gap-y-4 px-4'>
              <h2 className='font-dmSerif text-[32px] sm:text-[48px]'>Who we work with</h2>
              <p className='text-[15px] max-w-[445px] leading-7 mx-auto lg:mx-0'>Today, millions of people around the world have successfully connected their accounts to apps they love using our API. We provide developers with the tools they need to create easy and accessible experiences for their users. </p>
              <Link href={'/about'}>
                <button className='border border-waterWhite rounded-full w-[129px] h-[48px] mb-4 mx-auto lg:mx-0 hover:bg-waterWhite hover:text-sanJuanBlue font-bold'>About Us</button>
              </Link>
            </div>
          </div>
          {/* Right side */}
