      ...
      <div className='max-w-6xl mx-auto'>
        <div className='flex flex-col sm:flex-row items-center justify-between text-waterWhite px-4'>
          ...
          <div className="flex gap-x-8 pt-6 sm:pt-0">
            <Image src={'/shared/facebook.svg'} height={24} width={24} alt="" className="text-white cursor-pointer" />
            <Image src={'/shared/twitter.svg'} height={24} width={24} alt="" className="text-white cursor-pointer" />
            <Image src={'/shared/linkedin.svg'} height={24} width={24} alt="" className="text-white cursor-pointer" />
          </div>
        </div>
      </div>
    </footer>
